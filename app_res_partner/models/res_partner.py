...
class ResPartner(models.Model):
    ...
    debloque_exce_ch = fields.Boolean(string=u"Déblocage exceptionnel charcuterie")
    debloque_exce_vo = fields.Boolean(string=u"Déblocage exceptionnel volaille")
    ...
    def _on_change_credit(self):
        for record in self:
            ...
            if record.blocagex_limite_credit_charcuterie:
                ...
                record.bloque=False            #if record.blocagex_limite_credit_charcuterie:
                # if record.credit_charcuterie > record.limite_credit_charcuterie:
            #    record.bloque_ch=False
            #    record.bloque=False
